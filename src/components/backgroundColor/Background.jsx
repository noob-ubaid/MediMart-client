    ...
    <div className="relative min-h-screen w-full bg-black">
      ...
      <div
        className={cn(
          ...
          "[background-image:linear-gradient(to_right,#e4e4e740_1px,transparent_0.5px),linear-gradient(to_bottom,#e4e4e740_1px,transparent_0.5px)]",
          "dark:[background-image:linear-gradient(to_right,#e4e4e740_1px,transparent_0.5px),linear-gradient(to_bottom,#e4e4e740_1px,transparent_0.5px)]",
        )}
      />
