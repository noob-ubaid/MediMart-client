  ...
  return (
    <div>
      ...
      <motion.div
        ...
        className="bg-black py-6 grid grid-cols-2 md:grid-cols-4 gap-8 border border-white/[0.2] justify-items-center rounded-2xl mt-6 md:mt-8 text-white"
      >
        <div className="text-xl md:text-2xl text-center font-semibold">
          <CountUp start={0} end={1000} duration={1.8} />+
          <p className="font-medium text-center text-lg md:text-xl mt-1 font-secondary text-white/60">
            Happy Customers
          </p>
        </div>
        <div className="text-xl md:text-2xl text-center font-semibold">
        ...
        <div className="text-xl md:text-2xl text-center font-semibold">
          <CountUp start={0} end={24} duration={1.7} />/
          <CountUp start={0} end={7} duration={1.7} />
          <p className="font-medium text-center text-lg md:text-xl mt-1 font-secondary text-white/60">
        ...
        <div className="text-xl md:text-2xl text-center font-semibold">
          ...
          <p className="font-medium text-center text-lg md:text-xlmt-1 font-secondary text-white/60">
            Satisfaction Rate
          </p>
        </div>
      </motion.div>
